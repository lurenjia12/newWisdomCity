    ...
    <div class="rightBox">
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="sex" label="申请人"></el-table-column>
          <el-table-column prop="address" label="联系电话"></el-table-column>
          <el-table-column prop="name" label="纠纷描述"></el-table-column>
          <el-table-column prop="name" label="申请时间"></el-table-column>
          <el-table-column prop="name" label="纠纷类型"></el-table-column>
